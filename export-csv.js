...
function exportRepeatersCSV(rows) {
  const cols = ['senal','nombre','banda','zona','comuna','ubicacion','rx','tx','tono','potencia','ganancia','region','vence'];
  const headers = ['Señal','Club/Titular','Banda','Zona','Comuna','Ubicación','RX (MHz)','TX (MHz)','Tono','Pot. W','Gan. dBi','Región','Vence'];
